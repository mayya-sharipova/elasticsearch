...
tree. `path_hierarcy` tokenizer uses Lucene's
https://lucene.apache.org/core/8_0_0/analyzers-common/org/apache/lucene/analysis/path/PathHierarchyTokenizer.html[PathHierarchyTokenizer]
underneath.
...
`reverse`::
    If set to `true`, uses Lucene's
    http://lucene.apache.org/core/8_0_0/analyzers-common/org/apache/lucene/analysis/path/ReversePathHierarchyTokenizer.html[ReversePathHierarchyTokenizer],
