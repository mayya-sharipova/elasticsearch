...
public class MatchHighlighterTests extends HighlighterTestCase {

    public void testTermHighlighting() throws IOException {
        ...
        SearchSourceBuilder search = new SearchSourceBuilder().query(QueryBuilders.termQuery("field", "some"))
            .highlighter(new HighlightBuilder().field("field").highlighterType("match"));
