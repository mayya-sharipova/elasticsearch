...
public class GatewayIndexStateIT extends ESIntegTestCase {
     ...
     *  - an index will be closed with the unknown settings archived. IndexService will not be created
     *  -  an index with archived settings can't not be opened. IndexService will not be created
